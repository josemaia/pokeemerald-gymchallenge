...
const u8 gText_ThisIsAPokemon[] = _("This POKéMON is your dad's old ace.{PAUSE 96}\p");
...
const u8 gText_AceSelection[] = _("Select your ace POKéMON.\nIts type will be used for your gym.");
